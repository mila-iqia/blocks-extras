...
class BeamSearch(object):
    ...
    def _compile_scores_computer(self):
        scores = self.generator.readout.scores(
            **dict(zip(self.input_state_names, self.input_states) +
                   zip(self.context_names, self.contexts)))
        self.scores_computer = function(
    ...
    def compute_scores(self, contexts, states):
        ...
        return self.scores_computer(*(list(contexts.values()) +
                                      input_states))
